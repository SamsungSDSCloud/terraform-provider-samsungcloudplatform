---
page_title: "scp_mysql Resource - scp"
subcategory: ""
description: |-
...
- `mysql_servers` (Block List, Min: 1) Mysql servers (HA configuration when entering two server specifications) (see [below for nested schema](#nestedblock--mysql_servers))
